...
/* Add appsboot version. suchangyu. 20100702. begin */
#define MAX_VERSION_CHAR 40
static char appsboot_version[MAX_VERSION_CHAR + 1];

#define ATAG_BOOT_VERSION 0x4d534D71 
...
/* Add appsboot version. suchangyu. 20100702. end */
...
static int app_info_proc_show(struct seq_file *m, void *v)
{
  ...
  seq_printf(m, "%s\n%s\n", appsboot_version, S7_KERNEL_VERSION);
  /* Add appsboot version. suchangyu. 20100702. end */
  return 0;
}
