...
/* DSTxkf37152 xiangguangchao, begin 2011/3/9 */
#include <mach/board.h>
/* DSTxkf37152 xiangguangchao, end 2011/3/9 */
				   ...
				   struct pm8058_pwm_period *period)
{
	...
	/* DSTxkf37152 xiangguangchao change backlight level, begin 2011/3/9 */
		...
		if (period_n >= MAX_MPT) {
			...
			n = 6;
	#endif
	/* DSTxkf37152 xiangguangchao change backlight level, end 2011/3/9 */
