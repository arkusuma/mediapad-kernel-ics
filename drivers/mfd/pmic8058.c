...
#if defined(CONFIG_PMIC8058_OTHC_S7PRO)
#define PM8058_IRQ_BASE	 (NR_MSM_IRQS + NR_GPIO_IRQS)
#define HEADSET_DETECT_GPIO 143
#define IRQ_DETECT_OFFSET   ((NR_MSM_IRQS + HEADSET_DETECT_GPIO) - PM8058_IRQ_BASE)
#endif
...
static const struct resource othc1_cell_resources[] __devinitconst = {
	...
	{
		.name = NULL,
		.start = IRQ_DETECT_OFFSET, 
		.end   = IRQ_DETECT_OFFSET,
		.flags = IORESOURCE_IRQ,
	},
#endif	
	{
