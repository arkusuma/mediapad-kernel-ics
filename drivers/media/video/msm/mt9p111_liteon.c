...
#define REG_MT9P111_LITEON_MODEL_ID                       0x0000

#define MT9P111_LITEON_MODEL_ID                       0x2880
#define MT9P111_LITEON_TARGET_PLL_TIMING_96M 0
#define MT9P111_LITEON_TARGET_PLL_TIMING_76M 1
#define MT9P111_LITEON_STATUS_WAIT_TIMES_LONG 40
#define MT9P111_LITEON_STATUS_WAIT_TIMES_SHORT 3
#define MT9P111_LITEON_STATUS_WAIT_TIMES_MIDDLE 10
static bool CSI_CONFIG_MT9P111_LITEON = 0;
static bool Sensor_CONFIG_MT9P111_LITEON = 0;
//enter or exit software standby mode the time of timeout 
#define STANDBY_TIMEOUT  600

//static bool Sensor_OTPReaLensshading_MT9P111_Liteon = 0;
...
** 
=================================================================================*/
extern unsigned short BACK_CAMERA_SENSOR_DETECT;//= 0x0000;
//unsigned short BACK_CAMERA_SENSOR_DETECT = 0x0001;

/*========================================================================
**
** MT9P111_LITEON_INIT_FLAG
**
...
static unsigned short MT9P111_LITEON_INIT_FLAG = 0x0000;
/*=========================================================================
**
** MT9P111_LITEON_ENTER_STANDBY_FLAG
**
...
static unsigned short MT9P111_LITEON_ENTER_STANDBY_FLAG = 0x0000;
/*=========================================================================
**
** MT9P111_LITEON_EXIT_STANDBY_FLAG
**
** After the system initialization the senor,it will enter the standby mode.if it's failed,
** set the globle variable to 0x0000;
**
...
** 
=========================================================================*/
//First time,it will not use run exit standby.
static unsigned short MT9P111_LITEON_EXIT_STANDBY_FLAG = 0x0001;
/*============================================================================
							DATA DECLARATIONS
============================================================================*/
/*  720P @ 24MHz MCLK */
struct reg_addr_val_pair_struct mt9p111_liteon_init_settings_A_array[] = {
#if MT9P111_LITEON_TARGET_PLL_TIMING_96M
// [PLL_settings]
...
{0xC850, 0x00 ,    1},// CAM_CORE_A_ORIENTATION
...
{0xC888, 0x00,     1},// CAM_CORE_B_ORIENTATION
...
#if MT9P111_LITEON_TARGET_PLL_TIMING_76M
...
static struct reg_addr_val_pair_struct mt9p111_liteon_lensshading_default_array[] = {
...
#ifdef CONFIG_MT9P111_LITEON_OTP_LSC

static struct reg_addr_val_pair_struct mt9p111_liteon_lensshading_otp_array[] = {
{0x3640, 0xFFFF, 2},    //FIELD_WR= P_G1_P0Q0, 0x00B0
{0x3642, 0xFFFF, 2},    //FIELD_WR= P_G1_P0Q1, 0xED4A
{0x3644, 0xFFFF, 2},    //FIELD_WR= P_G1_P0Q2, 0x0631
{0x3646, 0xFFFF, 2},    //FIELD_WR= P_G1_P0Q3, 0x750D
{0x3648, 0xFFFF, 2},    //FIELD_WR= P_G1_P0Q4, 0x8A6F
{0x364A, 0xFFFF, 2},    //FIELD_WR= P_R_P0Q0,  0x7E8F
{0x364C, 0xFFFF, 2},    //FIELD_WR= P_R_P0Q1,  0x0169
{0x364E, 0xFFFF, 2},    //FIELD_WR= P_R_P0Q2,  0x0F51
{0x3650, 0xFFFF, 2},    //FIELD_WR= P_R_P0Q3,  0x130E
{0x3652, 0xFFFF, 2},    //FIELD_WR= P_R_P0Q4,  0xFC4D
{0x3654, 0xFFFF, 2},    //FIELD_WR= P_B_P0Q0,  0x7F4F
{0x3656, 0xFFFF, 2},    //FIELD_WR= P_B_P0Q1,  0x5D4B
{0x3658, 0xFFFF, 2},    //FIELD_WR= P_B_P0Q2,  0x5D30
{0x365A, 0xFFFF, 2},    //FIELD_WR= P_B_P0Q3,  0x5A4D
{0x365C, 0xFFFF, 2},    //FIELD_WR= P_B_P0Q4,  0xEAEE
{0x365E, 0xFFFF, 2},    //FIELD_WR= P_G2_P0Q0, 0x7E6F
{0x3660, 0xFFFF, 2},    //FIELD_WR= P_G2_P0Q1, 0xA34B
{0x3662, 0xFFFF, 2},    //FIELD_WR= P_G2_P0Q2, 0x0A71
{0x3664, 0xFFFF, 2},    //FIELD_WR= P_G2_P0Q3, 0x796D
{0x3666, 0xFFFF, 2},    //FIELD_WR= P_G2_P0Q4, 0xA42F
{0x3680, 0xFFFF, 2},    //FIELD_WR= P_G1_P1Q0, 0x666B
{0x3682, 0xFFFF, 2},    //FIELD_WR= P_G1_P1Q1, 0x012E
{0x3684, 0xFFFF, 2},    //FIELD_WR= P_G1_P1Q2, 0xE02B
{0x3686, 0xFFFF, 2},    //FIELD_WR= P_G1_P1Q3, 0x440C
{0x3688, 0xFFFF, 2},    //FIELD_WR= P_G1_P1Q4, 0x244F
{0x368A, 0xFFFF, 2},    //FIELD_WR= P_R_P1Q0,  0x78A9
{0x368C, 0xFFFF, 2},    //FIELD_WR= P_R_P1Q1,  0x090E
{0x368E, 0xFFFF, 2},    //FIELD_WR= P_R_P1Q2,  0x636D
{0x3690, 0xFFFF, 2},    //FIELD_WR= P_R_P1Q3,  0x08CD
{0x3692, 0xFFFF, 2},    //FIELD_WR= P_R_P1Q4,  0x1CAD
{0x3694, 0xFFFF, 2},    //FIELD_WR= P_B_P1Q0,  0x554B
{0x3696, 0xFFFF, 2},    //FIELD_WR= P_B_P1Q1,  0xA20A
{0x3698, 0xFFFF, 2},    //FIELD_WR= P_B_P1Q2,  0xCA2E
{0x369A, 0xFFFF, 2},    //FIELD_WR= P_B_P1Q3,  0x530D
{0x369C, 0xFFFF, 2},    //FIELD_WR= P_B_P1Q4,  0x0270
{0x369E, 0xFFFF, 2},    //FIELD_WR= P_G2_P1Q0, 0x692C
{0x36A0, 0xFFFF, 2},    //FIELD_WR= P_G2_P1Q1, 0x096D
{0x36A2, 0xFFFF, 2},    //FIELD_WR= P_G2_P1Q2, 0xB32F
{0x36A4, 0xFFFF, 2},    //FIELD_WR= P_G2_P1Q3, 0x494C 
{0x36A6, 0xFFFF, 2},    //FIELD_WR= P_G2_P1Q4, 0x1F70             
{0x36C0, 0xFFFF, 2},    //FIELD_WR= P_G1_P2Q0, 0x2531             
{0x36C2, 0xFFFF, 2},    //FIELD_WR= P_G1_P2Q1, 0x5ECD             
{0x36C4, 0xFFFF, 2},    //FIELD_WR= P_G1_P2Q2, 0xBCB2             
{0x36C6, 0xFFFF, 2},    //FIELD_WR= P_G1_P2Q3, 0x0AD0             
{0x36C8, 0xFFFF, 2},    //FIELD_WR= P_G1_P2Q4, 0x5EF3             
{0x36CA, 0xFFFF, 2},    //FIELD_WR= P_R_P2Q0, 0x2211              
{0x36CC, 0xFFFF, 2},    //FIELD_WR= P_R_P2Q1, 0x99EE              
{0x36CE, 0xFFFF, 2},    //FIELD_WR= P_R_P2Q2, 0x8451              
{0x36D0, 0xFFFF, 2},    //FIELD_WR= P_R_P2Q3, 0x6670              
{0x36D2, 0xFFFF, 2},    //FIELD_WR= P_R_P2Q4, 0x4B32              
{0x36D4, 0xFFFF, 2},    //FIELD_WR= P_B_P2Q0, 0x1AB1              
{0x36D6, 0xFFFF, 2},    //FIELD_WR= P_B_P2Q1, 0xF6CE              
{0x36D8, 0xFFFF, 2},    //FIELD_WR= P_B_P2Q2, 0xB4D2              
{0x36DA, 0xFFFF, 2},    //FIELD_WR= P_B_P2Q3, 0x08B1              
{0x36DC, 0xFFFF, 2},    //FIELD_WR= P_B_P2Q4, 0x05F4              
{0x36DE, 0xFFFF, 2},    //FIELD_WR= P_G2_P2Q0, 0x1E11             
{0x36E0, 0xFFFF, 2},    //FIELD_WR= P_G2_P2Q1, 0x6D8D             
{0x36E2, 0xFFFF, 2},    //FIELD_WR= P_G2_P2Q2, 0xB612             
{0x36E4, 0xFFFF, 2},    //FIELD_WR= P_G2_P2Q3, 0x1330             
{0x36E6, 0xFFFF, 2},    //FIELD_WR= P_G2_P2Q4, 0x56F3             
{0x3700, 0xFFFF, 2},    //FIELD_WR= P_G1_P3Q0, 0x990E             
{0x3702, 0xFFFF, 2},    //FIELD_WR= P_G1_P3Q1, 0x03CE             
{0x3704, 0xFFFF, 2},    //FIELD_WR= P_G1_P3Q2, 0x1811             
{0x3706, 0xFFFF, 2},    //FIELD_WR= P_G1_P3Q3, 0x392B             
{0x3708, 0xFFFF, 2},    //FIELD_WR= P_G1_P3Q4, 0xED32             
{0x370A, 0xFFFF, 2},    //FIELD_WR= P_R_P3Q0, 0x356B              
{0x370C, 0xFFFF, 2},    //FIELD_WR= P_R_P3Q1, 0x2268              
{0x370E, 0xFFFF, 2},    //FIELD_WR= P_R_P3Q2, 0x0B4F              
{0x3710, 0xFFFF, 2},    //FIELD_WR= P_R_P3Q3, 0x438E              
{0x3712, 0xFFFF, 2},    //FIELD_WR= P_R_P3Q4, 0x9692              
{0x3714, 0xFFFF, 2},    //FIELD_WR= P_B_P3Q0, 0x0FEE              
{0x3716, 0xFFFF, 2},    //FIELD_WR= P_B_P3Q1, 0x240F              
{0x3718, 0xFFFF, 2},    //FIELD_WR= P_B_P3Q2, 0x4030              
{0x371A, 0xFFFF, 2},    //FIELD_WR= P_B_P3Q3, 0x8150              
{0x371C, 0xFFFF, 2},    //FIELD_WR= P_B_P3Q4, 0xCD92              
{0x371E, 0xFFFF, 2},    //FIELD_WR= P_G2_P3Q0, 0xF6AD             
{0x3720, 0xFFFF, 2},    //FIELD_WR= P_G2_P3Q1, 0x6E8E             
{0x3722, 0xFFFF, 2},    //FIELD_WR= P_G2_P3Q2, 0x43F1             
{0x3724, 0xFFFF, 2},    //FIELD_WR= P_G2_P3Q3, 0x7D6B             
{0x3726, 0xFFFF, 2},    //FIELD_WR= P_G2_P3Q4, 0xFAD2             
{0x3740, 0xFFFF, 2},    //FIELD_WR= P_G1_P4Q0, 0x9431             
{0x3742, 0xFFFF, 2},    //FIELD_WR= P_G1_P4Q1, 0x1FCC             
{0x3744, 0xFFFF, 2},    //FIELD_WR= P_G1_P4Q2, 0x10F4             
{0x3746, 0xFFFF, 2},    //FIELD_WR= P_G1_P4Q3, 0xD852             
{0x3748, 0xFFFF, 2},    //FIELD_WR= P_G1_P4Q4, 0xE234             
{0x374A, 0xFFFF, 2},    //FIELD_WR= P_R_P4Q0, 0x81D1              
{0x374C, 0xFFFF, 2},    //FIELD_WR= P_R_P4Q1, 0x7F71              
{0x374E, 0xFFFF, 2},    //FIELD_WR= P_R_P4Q2, 0x0D13              
{0x3750, 0xFFFF, 2},    //FIELD_WR= P_R_P4Q3, 0xC5D3              
{0x3752, 0xFFFF, 2},    //FIELD_WR= P_R_P4Q4, 0x9334              
{0x3754, 0xFFFF, 2},    //FIELD_WR= P_B_P4Q0, 0xDD91              
{0x3756, 0xFFFF, 2},    //FIELD_WR= P_B_P4Q1, 0x2912              
{0x3758, 0xFFFF, 2},    //FIELD_WR= P_B_P4Q2, 0x34D4              
{0x375A, 0xFFFF, 2},    //FIELD_WR= P_B_P4Q3, 0xF373              
{0x375C, 0xFFFF, 2},    //FIELD_WR= P_B_P4Q4, 0xC655              
{0x375E, 0xFFFF, 2},    //FIELD_WR= P_G2_P4Q0, 0xF810             
{0x3760, 0xFFFF, 2},    //FIELD_WR= P_G2_P4Q1, 0xE30B             
{0x3762, 0xFFFF, 2},    //FIELD_WR= P_G2_P4Q2, 0x0794             
{0x3764, 0xFFFF, 2},    //FIELD_WR= P_G2_P4Q3, 0xF932
{0x3766, 0xFFFF, 2},    //FIELD_WR= P_G2_P4Q4, 0xD974             
{0x3782, 0xFFFF, 2},    //FIELD_WR= CENTER_ROW, 0x01E0
{0x3784, 0xFFFF, 2},    //FIELD_WR= CENTER_COLUMN, 0x0278         
};
#endif

struct reg_addr_val_pair_struct mt9p111_liteon_init_settings_B_array[] = {
...
{0xDC33, 0x08   , 1}, // SYS_FIRST_BLACK_LEVEL
...
{0xBC19, 0x18   , 1}, // LL_GAMMA_CONTRAST_CURVE_1
{0xBC1A, 0x25   , 1}, // LL_GAMMA_CONTRAST_CURVE_2
{0xBC1B, 0x3A   , 1}, // LL_GAMMA_CONTRAST_CURVE_3
{0xBC1C, 0x59   , 1}, // LL_GAMMA_CONTRAST_CURVE_4
{0xBC1D, 0x70   , 1}, // LL_GAMMA_CONTRAST_CURVE_5
{0xBC1E, 0x81   , 1}, // LL_GAMMA_CONTRAST_CURVE_6
{0xBC1F, 0x90   , 1}, // LL_GAMMA_CONTRAST_CURVE_7
{0xBC20, 0xA2   , 1}, // LL_GAMMA_CONTRAST_CURVE_8
{0xBC21, 0xAD   , 1}, // LL_GAMMA_CONTRAST_CURVE_9
{0xBC22, 0xBC   , 1}, // LL_GAMMA_CONTRAST_CURVE_10
{0xBC23, 0xC8   , 1}, // LL_GAMMA_CONTRAST_CURVE_11
{0xBC24, 0xD4   , 1}, // LL_GAMMA_CONTRAST_CURVE_12
{0xBC25, 0xDC   , 1}, // LL_GAMMA_CONTRAST_CURVE_13
{0xBC26, 0xE6   , 1}, // LL_GAMMA_CONTRAST_CURVE_14
{0xBC27, 0xEB   , 1}, // LL_GAMMA_CONTRAST_CURVE_15
{0xBC28, 0xF0   , 1}, // LL_GAMMA_CONTRAST_CURVE_16
{0xBC29, 0xF7   , 1}, // LL_GAMMA_CONTRAST_CURVE_17
{0xBC2A, 0xFF   , 1}, // LL_GAMMA_CONTRAST_CURVE_18
{0xBC2B, 0x00   , 1}, // LL_GAMMA_NEUTRAL_CURVE_0
{0xBC2C, 0x18   , 1}, // LL_GAMMA_NEUTRAL_CURVE_1
{0xBC2D, 0x25   , 1}, // LL_GAMMA_NEUTRAL_CURVE_2
{0xBC2E, 0x3A   , 1}, // LL_GAMMA_NEUTRAL_CURVE_3
{0xBC2F, 0x59   , 1}, // LL_GAMMA_NEUTRAL_CURVE_4
{0xBC30, 0x70   , 1}, // LL_GAMMA_NEUTRAL_CURVE_5
{0xBC31, 0x81   , 1}, // LL_GAMMA_NEUTRAL_CURVE_6
{0xBC32, 0x90   , 1}, // LL_GAMMA_NEUTRAL_CURVE_7
{0xBC33, 0xA2   , 1}, // LL_GAMMA_NEUTRAL_CURVE_8
{0xBC34, 0xAD   , 1}, // LL_GAMMA_NEUTRAL_CURVE_9
{0xBC35, 0xBC   , 1}, // LL_GAMMA_NEUTRAL_CURVE_10
{0xBC36, 0xC8   , 1}, // LL_GAMMA_NEUTRAL_CURVE_11
{0xBC37, 0xD4   , 1}, // LL_GAMMA_NEUTRAL_CURVE_12
{0xBC38, 0xDC   , 1}, // LL_GAMMA_NEUTRAL_CURVE_13
{0xBC39, 0xE6   , 1}, // LL_GAMMA_NEUTRAL_CURVE_14
{0xBC3A, 0xEB   , 1}, // LL_GAMMA_NEUTRAL_CURVE_15
{0xBC3B, 0xF0   , 1}, // LL_GAMMA_NEUTRAL_CURVE_16
{0xBC3C, 0xF7   , 1}, // LL_GAMMA_NEUTRAL_CURVE_17
...
struct mt9p111_liteon_work_t {
	struct work_struct work;
};
static struct  mt9p111_liteon_work_t *mt9p111_liteon_sensorw;
static struct  i2c_client *mt9p111_liteon_client;
struct mt9p111_liteon_ctrl_t {
	...
	enum mt9p111_liteon_resolution_t prev_res;
	enum mt9p111_liteon_resolution_t pict_res;
	enum mt9p111_liteon_resolution_t curr_res;
	enum mt9p111_liteon_test_mode_t  set_test;
	unsigned short imgaddr;
};
static struct mt9p111_liteon_ctrl_t *mt9p111_liteon_ctrl;
static DECLARE_WAIT_QUEUE_HEAD(mt9p111_liteon_wait_queue);
DEFINE_MUTEX(mt9p111_liteon_mut);

/*=============================================================*/

static int mt9p111_liteon_i2c_rxdata(unsigned short saddr,
	unsigned char *rxdata, int length)
{
	...
	if (i2c_transfer(mt9p111_liteon_client->adapter, msgs, 2) < 0) {
		CDBG("mt9p111_liteon_i2c_rxdata failed!\n");
		return -EIO;
	}
	return 0;
}
static int32_t mt9p111_liteon_i2c_txdata(unsigned short saddr,
				unsigned char *txdata, int length)
{
	...
	if (i2c_transfer(mt9p111_liteon_client->adapter, msg, 1) < 0) {
		printk("mt9p111_liteon_i2c_txdata faild 0x%x\n", mt9p111_liteon_client->addr);
		return -EIO;
	}
...
static int32_t mt9p111_liteon_i2c_read(unsigned short raddr,
	unsigned short *rdata)
{
	...
	buf[1] = (raddr & 0x00FF);
	rc = mt9p111_liteon_i2c_rxdata(mt9p111_liteon_client->addr, buf, 2);
	if (rc < 0) {
		printk("mt9p111_liteon_i2c_read 0x%x failed!\n", raddr);
		return rc;
	}
	*rdata = buf[0] << 8 | buf[1];
	return rc;
}
static int32_t mt9p111_liteon_i2c_write_b_sensor(unsigned short waddr, unsigned short bdata,  int width)
{
	int32_t rc = -EIO;
	unsigned char buf[4];
	...
	case WORD_LEN: {
		...
		buf[3] = (bdata & 0x00FF);
		//rc = mt9p111_liteon_i2c_txdata(mt9p111_liteon_client->addr >> 1, buf, 4);
		rc = mt9p111_liteon_i2c_txdata(mt9p111_liteon_client->addr, buf, 4);
	}
		break;
	...
	case BYTE_LEN: {
		...
		rc = mt9p111_liteon_i2c_txdata(mt9p111_liteon_client->addr, buf, 3);
	}
		break;
...
struct ModuleInfo
{
    ...
    unsigned short S7_id;
    unsigned short maker_info;
};

static unsigned short OTPDoneFlag = 0x0000;
static unsigned short OTPDoneFlagNum[6] = {0x0000,0x0000,0x0000,0x0000,0x0000,0x0000};

const unsigned short ShadingFlag[6] = {0x04C2,0x6241,0x04C2,0x6242,0x04C2,0x6243};

static unsigned short OTPStartAddress = 0x0000;

static unsigned short OTPWrite_FW_HW = 0x0000;

static unsigned short Sensor_OTPReaLensshading_MT9P111_Liteon = 0;

const unsigned short OTPFlagValue[2] = {0x0000,0x0002};

#define OTP_TIMEOUT 600

struct reg_addr_val_pair_struct   mt9p111_liteon_OTP_init_settings_arrayA[] = {
{0x0010, 0x032D, 2},                              
{0x0012, 0x00B0, 2},                     
{0x0014, 0x2025, 2},                                        
{0x001E, 0x0770, 2},// PAD_SLEW_PAD_CONFIG           

{0x0022, 0x00F0, 2},// VDD_DIS_COUNTER 0x00F0
{0x002A, 0x7F8A, 2},                      
{0x002C, 0x0000, 2},
{0x002E, 0x0000, 2},                                       
...
struct reg_addr_val_pair_struct   mt9p111_liteon_OTP_init_settings_arrayB[] = {
{0x3812, 0x212C, 2}, //0x212C                
{0x3814, 0x0F1F, 2},                                      
{0x3816, 0x0F1F, 2},                                        
{0x3818, 0x4407, 2}, // PAD_SLEW_PAD_CONFIG
{0x098E, 0x602A, 2},
{0xE02A, 0x0001, 2},
};

static int32_t mt9p111_liteon_check_read_order(void)
{
    int32_t rc = 0;
    unsigned short i = 0;
    unsigned short OTPValue =0xFFFF;
    unsigned short OTPValueCheck[2] ={0xFFFF,0xFFFF};
    printk("%s ---begin!\n",__FUNCTION__);

    mt9p111_liteon_i2c_write_b_sensor(0x3802, 0x0000, 2);
    mt9p111_liteon_i2c_write_b_sensor(0x3804, 0x0009, 2);//read row 9   
    for(i = 0; i < 2; i++)
    {
        rc = mt9p111_liteon_i2c_write_b_sensor(0x3802,0x0009,2);
        if(rc<0)
        {
            printk("%s IIC Write Failed!\n",__FUNCTION__);
            goto read_order_fail;
        }
        //low word
        msleep(10);
        rc = mt9p111_liteon_i2c_read(0x380C, &OTPValue);
        if(rc<0)
        {
            printk("%s IIC Write Failed!\n",__FUNCTION__);
            goto read_order_fail;
        ...
        OTPValueCheck[i] = OTPValue;

        //high word
        i++;
        rc = mt9p111_liteon_i2c_read(0x380E, &OTPValue);
        if(rc<0)
        {
            printk("%s IIC Write Failed!\n",__FUNCTION__);
            goto read_order_fail;
    ...
    mt9p111_liteon_i2c_write_b_sensor(0x3802,0x0000,2);
    // tht first 300PCS module must read follow  0x380C,then 0x380E.And others follow 0x380E,then 0x380C
    if(0x2011 == OTPValueCheck[0] && 0x0720 == OTPValueCheck[1] )
    {
        OTPWrite_FW_HW = 0x0000;
        printk("%s OTPWrite_FW_HW = 0x%04X\n",__FUNCTION__,OTPWrite_FW_HW);
        printk("The sensor is one of the 300PCS module!---------------\n");
    }
    else 
    {
        OTPWrite_FW_HW = 0x0001;
        printk("%s OTPWrite_FW_HW = 0x%04X\n",__FUNCTION__,OTPWrite_FW_HW);
        printk("The sensor is New!-----------------!\n");
    }
    printk("%s ---end--Successful!\n",__FUNCTION__);
    return rc;
read_order_fail:
    OTPWrite_FW_HW = 0xFFFF;
    printk("%s: OTPWrite_FW_HW = 0x%04X\n",__FUNCTION__,OTPWrite_FW_HW);
    printk("%s ---end--Failed!\n",__FUNCTION__);
    return rc;
}

static int32_t mt9p111_liteon_check_otp(void)
{
    int32_t rc = 0;
    unsigned short i = 0;
    unsigned short OTPValue =0xFFFF;
    ...
    mt9p111_liteon_i2c_write_b_sensor(0x3802, 0x0000, 2);
    mt9p111_liteon_i2c_write_b_sensor(0x3804, 0x0001, 2);//read row 1   
    for(i = 0; i < 2; i++)
    {    
        rc = mt9p111_liteon_i2c_write_b_sensor(0x3802,0x0009,2);
        if(rc<0)
        ...
        //low word
        msleep(10);
        if(0x0000 == OTPWrite_FW_HW)
        {
            rc = mt9p111_liteon_i2c_read(0x380C, &OTPValue);
        }
        else if(0x0001 == OTPWrite_FW_HW )
        {
            rc = mt9p111_liteon_i2c_read(0x380E, &OTPValue);
        } 
        if(rc<0)
        ...
        if (OTPFlagValue[i]==OTPValueCheck[i])
        {
            printk("%s Successful! OTPValueCheck[%d] = 0x%04X\n",__FUNCTION__, i, OTPValueCheck[i]);
        }
        else
        {
            printk("%s Failed! OTPValueCheck[%d] = 0x%04X\n",__FUNCTION__, i, OTPValueCheck[i]);
            goto check_otp_fail;
        }

        //high word
        i++;
        //here,must swap 0x380E and 0x380C
        if(0x0000 == OTPWrite_FW_HW)
        {
            rc = mt9p111_liteon_i2c_read(0x380E, &OTPValue);
        }
    ...
    //Here ,OTPFlagValue[0] = 0x0000,OTPFlagValue[0] = 0x0002  
    OTPDoneFlag = 0x0001;
    printk("%s: OTPDoneFlag = 0x%04x\n",__FUNCTION__,OTPDoneFlag);
    printk("%s ---end--Successful!\n",__FUNCTION__);
    return rc;
check_otp_fail:
    OTPDoneFlag = 0x0000;
...
static int32_t mt9p111_liteon_check_otp_start_address(void)
{
    int32_t rc = 0;
    int32_t i = 0;
    unsigned short OTPValueNum[6] = {0x0000};
    unsigned short OTPValue = 0x0000;

    printk("%s ---begin!\n",__FUNCTION__);
    //Step 1========================================================
    //printk("1 here ==================================================\n");
    mt9p111_liteon_i2c_write_b_sensor(0x3802, 0x0000, 2);
    mt9p111_liteon_i2c_write_b_sensor(0x3804, 0x0002, 2);//read row 2 - 4   
    for(i = 0; i < 6; i++)
    {    
        rc = mt9p111_liteon_i2c_write_b_sensor(0x3802,0x0009,2);
        if(rc<0)
        ...
        if(rc<0)
        {
            printk("%s IIC Read Failed!\n",__FUNCTION__);
            goto check_otp_fail;
        }
            
        OTPValueNum[i] = OTPValue;
       
        if(ShadingFlag[i] == OTPValueNum[i])
        {
            OTPDoneFlagNum[i] = 0x0001;
            printk("%s OTPValueNum[%d] = 0x%04X\n",__FUNCTION__, i, OTPValueNum[i]);
        }
        else
        {
            printk("%s OTPValueNum[%d] = 0x%04X\n",__FUNCTION__, i, OTPValueNum[i]);
            OTPDoneFlagNum[i] = 0x0000;
        }
    ...
    //Step 1========================================================
    //printk("1 here ==================================================\n");
    //check otp start address
    if(0x0001 == OTPDoneFlagNum[0] && 0x0001 == OTPDoneFlagNum[1]    
    && 0x0001 == OTPDoneFlagNum[2] && 0x0001 == OTPDoneFlagNum[3]
    && 0x0001 == OTPDoneFlagNum[4] && 0x0001 == OTPDoneFlagNum[5])

        OTPStartAddress = 0x008B;//third

    else if(0x0001 == OTPDoneFlagNum[0] && 0x0001 == OTPDoneFlagNum[1]    
         && 0x0001 == OTPDoneFlagNum[2] && 0x0001 == OTPDoneFlagNum[3]
         && 0x0000 == OTPDoneFlagNum[4] && 0x0000 == OTPDoneFlagNum[5])
         
        OTPStartAddress = 0x0047;//second

    else if(0x0001 == OTPDoneFlagNum[0] && 0x0001 == OTPDoneFlagNum[1]    
         && 0x0000 == OTPDoneFlagNum[2] && 0x0000 == OTPDoneFlagNum[3]
         && 0x0000 == OTPDoneFlagNum[4] && 0x0000 == OTPDoneFlagNum[5])
         
        OTPStartAddress = 0x000B;//first
    else
        goto check_otp_fail;

    printk("%s OTPStartAddress = 0x%04X\n",__FUNCTION__,OTPStartAddress);
    printk("%s ---end--Successful!\n",__FUNCTION__);
    return rc;
check_otp_fail:
    printk("%s OTPStartAddress = 0x%04X\n",__FUNCTION__,OTPStartAddress);
...
static int32_t mt9p111_liteon_module_info(void)
{
    struct ModuleInfo mt9p111_liteon_module;
    unsigned char *Maker;
    unsigned short MakerID;
    unsigned short Version;
    unsigned short ModuleInfo[4] = {0x0000};
    unsigned short OTPValue = 0x0000;
    int32_t rc = 0;
    unsigned short i =0;
    ...
    //printk("1 here ==================================================\n");
    mt9p111_liteon_i2c_write_b_sensor(0x3802, 0x0000, 2);
    mt9p111_liteon_i2c_write_b_sensor(0x3804, (OTPStartAddress -0x0002), 2);//read row 2 - 4   
    for(i = 0; i < 6; i++)
    {    
        rc = mt9p111_liteon_i2c_write_b_sensor(0x3802,0x0009,2);
        if(rc<0)
    ...
    mt9p111_liteon_module.year = ModuleInfo[0];
    mt9p111_liteon_module.month = ModuleInfo[1];
    mt9p111_liteon_module.S7_id = ModuleInfo[2];
    mt9p111_liteon_module.maker_info = ModuleInfo[3];

    MakerID = (mt9p111_liteon_module.maker_info) >>12 & 0x000F;
    Version = (mt9p111_liteon_module.maker_info) >>8  & 0x000F;
    ...
    printk("%s :Year    = %04X\n",__FUNCTION__,mt9p111_liteon_module.year);
    printk("%s :Month   = %04X\n",__FUNCTION__,mt9p111_liteon_module.month);
    printk("%s :Maker   = %s\n",__FUNCTION__,Maker);
    printk("%s :Version = %d\n",__FUNCTION__,Version);
    printk("%s :%04X/%04X,%s,Version %d.0\n",__FUNCTION__,mt9p111_liteon_module.year, mt9p111_liteon_module.month,Maker,Version);
...
static int32_t mt9p111_liteon_ReadOTPLensShading(void)
{
    unsigned short i = 0;
    unsigned short k = 0;
    unsigned short readValue = 0xFFFF;
    ...
    mt9p111_liteon_i2c_write_b_sensor(0x3802, 0x0000, 2);
    mt9p111_liteon_i2c_write_b_sensor(0x3804, OTPStartAddress, 2);   

    if(0x0001 == OTPWrite_FW_HW)
    {  
        for(i=0; i<102; i++)
        {
            rc = mt9p111_liteon_i2c_write_b_sensor(0x3802,0x0009,2);
            ...
            msleep(2);
            rc = mt9p111_liteon_i2c_read(0x380E, &readValue);
            if(rc<0)
            {
                printk("%s IIC Write Failed!\n",__FUNCTION__);
                goto otp_read_fail;
            }
            mt9p111_liteon_lensshading_otp_array[i].reg_val = readValue;
            //printk("i = %03d ,value = 0x%04X\n", i, mt9p111_liteon_lensshading_otp_array[i].reg_val);
            i++;
            rc =  mt9p111_liteon_i2c_read(0x380C, &readValue);
            if(rc<0)
            {
                printk("%s IIC Write Failed!\n",__FUNCTION__);
                goto otp_read_fail;
    ...
    else if(0x0000 == OTPWrite_FW_HW)
    {
        for(i=0,k=0; i<108; i++)
        {
            ...
            if( (i == 12) ||( i == 46 )||( i == 80))
            {
                // printk("%s:Skip the number %d,and then read %d\n",__FUNCTION__,i,i+2);
                mt9p111_liteon_i2c_read(0x380C, &readValue);
                msleep(5);
                mt9p111_liteon_i2c_read(0x380E, &readValue);
                i++;
            }
            else
            {
                ...
                mt9p111_liteon_lensshading_otp_array[k].reg_val = readValue;
                //printk("k  = %03d ,value = 0x%04X\n", k, mt9p111_liteon_lensshading_otp_array[k].reg_val);
                i++;
                k++;
                rc =  mt9p111_liteon_i2c_read(0x380E, &readValue);
                if(rc < 0)
        ...
        //swap the regsiter 100 and 101 for the first 300PCS module.
        temp = mt9p111_liteon_lensshading_otp_array[100].reg_val;
        mt9p111_liteon_lensshading_otp_array[100].reg_val = mt9p111_liteon_lensshading_otp_array[101].reg_val;
        mt9p111_liteon_lensshading_otp_array[101].reg_val = temp;
    }
    mt9p111_liteon_i2c_write_b_sensor(0x3802,0x0000,2);
    printk("%s  Read OTP Successful!\n",__FUNCTION__);	
    return rc;
otp_read_fail:
    printk("%s  Read OTP Failed!\n",__FUNCTION__);
    return rc;
}

static int mt9p111_liteon_probe_init_sensor_otp(const struct msm_camera_sensor_info *data)
{
    unsigned short model_id = 0x0000;
    unsigned short OTPCheckValue = 0x0000;
    int rc = 0;
    unsigned short i = 0;
    unsigned short array_length = 0;
    ...
    //reset the sensor
    rc = gpio_request(data->sensor_reset, "mt9p111_liteon");
    if (!rc)
    {
    ...
    {
        printk("mt9p111_liteon gpio reset fail");
        goto init_probe_done;
    }
    //printk("1 here ==================================================\n");
    //Step 1========================================================
    //1.Read sensor Model ID: 
    rc = mt9p111_liteon_i2c_read(REG_MT9P111_LITEON_MODEL_ID, &model_id);
    if(rc<0)
        goto init_probe_fail;
    printk("mt9p111_liteon model_id = 0x%x\n",model_id);
    
    //printk("2 here ==================================================\n");
    //Step 2========================================================
    //2.Compare sensor ID to MT9P111 ID:
    if (model_id != MT9P111_LITEON_MODEL_ID)
    {
        rc = -ENODEV;
        goto init_probe_fail;
    }
    //printk("3 here ==================================================\n");
    //Step 3========================================================
    //3.OTP initialization A
    array_length = sizeof(mt9p111_liteon_OTP_init_settings_arrayA) /
            sizeof(mt9p111_liteon_OTP_init_settings_arrayA[0]);
    for(i = 0; i < array_length; i++)
    {
        rc = mt9p111_liteon_i2c_write_b_sensor(
            mt9p111_liteon_OTP_init_settings_arrayA[i].reg_addr,
            mt9p111_liteon_OTP_init_settings_arrayA[i].reg_val, 
            mt9p111_liteon_OTP_init_settings_arrayA[i].lens);
        if(rc < 0)
        {
            printk("%s  OTP initialization A failed\n",__FUNCTION__);
            goto init_probe_fail;    
        }
    }
    printk("%s OTP initialization A successful----!\n",__FUNCTION__);
    //printk("4 here ==================================================\n");
    //Step 4========================================================
    //POLL R0x0014[15] until its value = 1  PLL locked DELAY 50ms
    for(timeout = 10; timeout <= OTP_TIMEOUT; timeout += 10 )
    {
        rc = mt9p111_liteon_i2c_read(0x0014, &OTPCheckValue);
        if(rc < 0)
        {
            printk("%s  POLL R0x0014[15] failed--Read\n",__FUNCTION__);
            goto init_probe_fail;
        }
        OTPCheckValue = (OTPCheckValue >>15) & 0x0001;
        if(0x0001 == OTPCheckValue)
        {
            printk("%s POLL R0x0014[15] ,0x0014 = 0x%04X\n",__FUNCTION__,OTPCheckValue);
            printk("%s POLL R0x0014[15] ,timeout = %d\n",__FUNCTION__,timeout);
            break;
        }
        else
        {
        ...
        if(timeout >= OTP_TIMEOUT)
        {
            printk("%s:POLL R0x0014[15] Failed!0x0014 = 0x%04X\n",__FUNCTION__,OTPCheckValue);
            printk("%s:POLL R0x0014[15] Failed!timeout = %d\n",__FUNCTION__,timeout);
            goto init_probe_fail;
        }
    }
    //delay for POLL
    ...
    for (timeout = 10; timeout <=  OTP_TIMEOUT; timeout += 10 )
    {
        rc = mt9p111_liteon_i2c_read(0x0018, &OTPCheckValue);
        if(rc < 0)
        {
            printk("%s  POLL R0x0018[14] failed--Read\n",__FUNCTION__);
            goto init_probe_fail;
        }
        OTPCheckValue = (OTPCheckValue >> 14) & 0x0001;
        if(0x0000 == OTPCheckValue)
        {    
            printk("%s POLL R0x0018[14] ,0x0018 = 0x%04X\n",__FUNCTION__,OTPCheckValue);
            printk("%s POLL R0x0018[14] ,timeout = %d\n",__FUNCTION__,timeout);
            break;
        }
        else
        {
        ...
        if(timeout >= OTP_TIMEOUT)
        {
            printk("%s:POLL R0x0018[14] Failed!0x0018 = 0x%04X\n",__FUNCTION__,OTPCheckValue);
            printk("%s:POLL R0x0018[14] Failed!timeout = %d\n",__FUNCTION__,timeout);
            goto init_probe_fail;
        }
    }
    //printk("6 here ==================================================\n");
    //Step 6========================================================
    //OTP initialization B
    array_length = sizeof(mt9p111_liteon_OTP_init_settings_arrayB) /
            sizeof(mt9p111_liteon_OTP_init_settings_arrayB[0]);
    for(i = 0; i < array_length; i++)
    {
        rc = mt9p111_liteon_i2c_write_b_sensor(
            mt9p111_liteon_OTP_init_settings_arrayB[i].reg_addr,
            mt9p111_liteon_OTP_init_settings_arrayB[i].reg_val, 
            mt9p111_liteon_OTP_init_settings_arrayB[i].lens);
        if(rc < 0)
        {
            printk("%s  OTP initialization B failed\n",__FUNCTION__);
            goto init_probe_fail;    
        }                    
    }
    printk("%s OTP initialization B successful----!\n",__FUNCTION__);
    //delay for initialization
    msleep(100);

    //printk("7 here ==================================================\n");
    //Step 7========================================================
    //first--check otp read order
    rc = mt9p111_liteon_check_read_order();
    if(rc < 0)
    {
        printk("Calling mt9p111_liteon_check_read_order  Failed !\n");
        goto init_probe_fail;
    }
    //second--check otp
    rc = mt9p111_liteon_check_otp();
    if(rc < 0)
    {
        printk("Calling mt9p111_liteon_check_otp  Failed !\n");
        goto init_probe_fail;
    }
    if(0x1 == OTPDoneFlag)
    {
        //third--check otp start address
        rc = mt9p111_liteon_check_otp_start_address();
        if(rc < 0)
        {
            printk("Calling mt9p111_liteon_check_otp_start_address  Failed !\n");
            goto init_probe_fail;
        }
        //fourth--read module info
        rc = mt9p111_liteon_module_info();
        if(rc < 0)
        {
            printk("Calling mt9p111_liteon_module_info  Failed !\n");
            goto init_probe_fail;
        }
        //printk("8 here ==================================================\n");
        //Step 8========================================================
        // fourth--  read OTP lenshading
        rc = mt9p111_liteon_ReadOTPLensShading();
        if(rc < 0)
        {
            printk("OTP:Call mt9p111_liteon_ReadOTPLensShading  failed  Sensor_OTPReaLensshading_MT9P111 = 0\n");
            Sensor_OTPReaLensshading_MT9P111_Liteon = 0;
        }
        else
        {
            printk("OTP:Call mt9p111_liteon_ReadOTPLensShading  succeed  Sensor_OTPReaLensshading_MT9P111 = 1\n");
            Sensor_OTPReaLensshading_MT9P111_Liteon = 1;    
        }
    }
    //printk("9 here ==================================================\n");
    //Step 9========================================================
    //finish OTP read lenshading, change the mclk to 24MHz
    msm_camio_clk_rate_set(24000000);
    msleep(20);
    printk("mt9p111_liteon_probe_init_sensor_otp----change the mclk\n");
...
// for gpio_request fail
init_probe_done:
    printk("%s:-- gpio_request Failed\n",__FUNCTION__);
    return rc;
}
#endif
static int32_t mt9p111_liteon_enter_standby(void)
{
    int32_t rc = 0;
    ...
    rc = mt9p111_liteon_i2c_write_b_sensor(0x3400,0x7A26,2);
    if(rc < 0)
        goto enter_standby_fail;
    //Is 0x3402 bit0  1?
    for(timeout= 0;timeout < STANDBY_TIMEOUT + 10; timeout += 10)
    {
        mt9p111_liteon_i2c_read(0x3402, &model_id);
        ...
        {
            MT9P111_LITEON_ENTER_STANDBY_FLAG = 0x0000;
            printk("**************************************************\n");
            printk("**************************************************\n");
            printk("**************************************************\n");
    ...
    rc = mt9p111_liteon_i2c_write_b_sensor(0x0018,0x2009,2);
    if(rc < 0)
        goto enter_standby_fail;
    //Is 0x0018 bit14  1?    
      for(timeout = 0;timeout < STANDBY_TIMEOUT + 10;timeout += 10)
      {
        mt9p111_liteon_i2c_read(0x0018, &model_id);
        model_id = model_id >>14;
        if(1 == model_id)
        {
            MT9P111_LITEON_ENTER_STANDBY_FLAG = 0x0001;
            printk("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n");
            printk("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n");
            printk("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n");
            printk("HaHa %s:Successful !0x0018 = 0x%04x\n",__FUNCTION__,model_id);
            printk("HaHa %s:Successful !timeout = %d\n",__FUNCTION__,timeout+10);
            break;
        }
        else
        {
...
static int32_t mt9p111_liteon_exit_standby(void)
{
    int32_t rc = 0;
    uint16_t model_id=0xFFFF;
    uint16_t timeout = 0;

    rc = mt9p111_liteon_i2c_write_b_sensor(0x0018,0x2008,2);
    if(rc < 0)
    ...
    for(timeout = 0;timeout < STANDBY_TIMEOUT +10;timeout +=10)
      {      
        ...
        if(0 == model_id)
        {
            MT9P111_LITEON_EXIT_STANDBY_FLAG = 0x0001;
            printk("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n");
            printk("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n");
            printk("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n");
            printk("HaHa %s:Successful !0x0018 = 0x%04x\n",__FUNCTION__,model_id);
    ...
    printk("mt9p111_liteon_exit_standby\n");
    return rc;
...
static int32_t mt9p111_liteon_sensor_setting(int update_type, int rt)
{
    int32_t i = 0;
    int32_t array_length = 0;
    int32_t time_out = 0;
    int32_t rc = 0;
    struct msm_camera_csi_params mt9p111_liteon_csi_params;
    uint16_t model_id = 0;

    switch (update_type) {
    case REG_INIT:
        CSI_CONFIG_MT9P111_LITEON = 0;
        Sensor_CONFIG_MT9P111_LITEON = 0;
        break;
    case UPDATE_PERIODIC:
        if (!CSI_CONFIG_MT9P111_LITEON) {
            mt9p111_liteon_csi_params.lane_cnt = 1;
            mt9p111_liteon_csi_params.data_format = CSI_8BIT;
            mt9p111_liteon_csi_params.lane_assign = 0xe4;
            mt9p111_liteon_csi_params.dpcm_scheme = 0;
            mt9p111_liteon_csi_params.settle_cnt = 0x18;
            
            rc = msm_camio_csi_config(&mt9p111_liteon_csi_params);
            msleep(10);
            CSI_CONFIG_MT9P111_LITEON = 1;
        }
        if (rt == RES_PREVIEW ) {
            if (!Sensor_CONFIG_MT9P111_LITEON){
                printk("mt9p111_liteon_sensor_setting--setting preview---begin\n");
                ...
                Sensor_CONFIG_MT9P111_LITEON = 1;
                ...
                if( 0x0000 == MT9P111_LITEON_ENTER_STANDBY_FLAG 
                 || 0x0000 == MT9P111_LITEON_INIT_FLAG 
                 || 0x0000 == MT9P111_LITEON_EXIT_STANDBY_FLAG){
             
                    printk("MT9P111_LITEON_ENTER_STANDBY_FLAG = %d  Shit!It's running as slow as a snail!\n",MT9P111_LITEON_ENTER_STANDBY_FLAG);
                    printk("MT9P111_LITEON_INIT_FLAG = %d  Shit!It's running as slow as a snail!\n",MT9P111_LITEON_INIT_FLAG);
                    printk("MT9P111_LITEON_EXIT_STANDBY_FLAG = %d  Shit!It's running as slow as a snail!\n",MT9P111_LITEON_EXIT_STANDBY_FLAG);
                    //********* write init setting  init setting( A )  ***********
                    printk("WAC: write init setting  init setting( A )--\n");
                    array_length = sizeof(mt9p111_liteon_init_settings_A_array) /
                        sizeof(mt9p111_liteon_init_settings_A_array[0]);
                    for (i = 0; i < array_length; i++)
                    {
                        rc = mt9p111_liteon_i2c_write_b_sensor(
                            mt9p111_liteon_init_settings_A_array[i].reg_addr,
                            mt9p111_liteon_init_settings_A_array[i].reg_val, 
                            mt9p111_liteon_init_settings_A_array[i].lens);
                        if (rc < 0)
                        {
                    ...
                    // the sensor is OTP and the month of  Module info is not 0x0720
                    // if(Sensor_OTPReaLensshading_MT9P111_Liteon && OTPWrite_FW_HW)
                    if(Sensor_OTPReaLensshading_MT9P111_Liteon)            
                    {
                        printk("WAC:write lens shading from OTP--\n");
                        mt9p111_liteon_i2c_write_b_sensor(0x3210, 0x49B0, 2);

                        array_length = sizeof(mt9p111_liteon_lensshading_otp_array) /
                            sizeof(mt9p111_liteon_lensshading_otp_array[0]);
                        for (i = 0; i < array_length; i++)
                        {
                            rc = mt9p111_liteon_i2c_write_b_sensor(
                                mt9p111_liteon_lensshading_otp_array[i].reg_addr,
                                mt9p111_liteon_lensshading_otp_array[i].reg_val, 
                                mt9p111_liteon_lensshading_otp_array[i].lens);
                            if(rc < 0)
                            {
                                printk("%s: Write the sensor register failed!----setting( OTP )\n",__FUNCTION__);
                                return rc;
                            }
                        }           
                        mt9p111_liteon_i2c_write_b_sensor(0x3210, 0x49B8, 2);
                    }
                    else
                    {
                        printk("WAC:write lens shading from default setting--\n");
                        array_length = sizeof(mt9p111_liteon_lensshading_default_array) /
                            sizeof(mt9p111_liteon_lensshading_default_array[0]);
                        for (i = 0; i < array_length; i++)
                        {   
                            rc = mt9p111_liteon_i2c_write_b_sensor(
                                mt9p111_liteon_lensshading_default_array[i].reg_addr,
                                mt9p111_liteon_lensshading_default_array[i].reg_val, 
                                mt9p111_liteon_lensshading_default_array[i].lens);
                            if (rc < 0)
                            {
                    ...
                    array_length = sizeof(mt9p111_liteon_init_settings_B_array) /
                        sizeof(mt9p111_liteon_init_settings_B_array[0]);
                    for (i = 0; i < array_length; i++)
                    {
                        rc = mt9p111_liteon_i2c_write_b_sensor(
                            mt9p111_liteon_init_settings_B_array[i].reg_addr,
                            mt9p111_liteon_init_settings_B_array[i].reg_val, 
                            mt9p111_liteon_init_settings_B_array[i].lens);
                        if (rc < 0)
                        {
                    ...
                    //if initialization the register again,set MT9P111_LITEON_INIT_FLAG to be 0x0001.
                    MT9P111_LITEON_INIT_FLAG = 0x0001;
                    mdelay(30);
                    mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x8404, 2);
                    mt9p111_liteon_i2c_read(0x8404, &model_id); 
                    model_id = (model_id & 0xFF00 ) >> 8;    
                    printk("Preview:mt9p111_liteon reg=0x8404, value = 0x%x\n", model_id);

                    mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x8404, 2);  
                    mt9p111_liteon_i2c_read(0x8404, &model_id) ;
                    model_id = (model_id & 0x00FF );
                    printk("Preview:mt9p111_liteon reg=0x8405, value = 0x%x\n", model_id);
                
                    mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x8405, 2);  
                    mt9p111_liteon_i2c_read(0x8405, &model_id) ;
                    model_id = (model_id & 0xFF00 ) >> 8;
                    printk("Preview:mt9p111_liteon reg=0x8405, value = 0x%x\n", model_id);

                    mt9p111_liteon_i2c_write_b_sensor(0x098E, 0xDC38, 2);  
                    mt9p111_liteon_i2c_read(0xDC38, &model_id) ;
                    model_id = (model_id & 0xFF00 ) >> 8;
                    printk("Preview:mt9p111_liteon reg=DC38, value = 0x%x\n", model_id);
                }
                else
                {
                    printk("MT9P111_LITEON_ENTER_STANDBY_FLAG = %d  Congratulations!It's running so fast!\n",MT9P111_LITEON_ENTER_STANDBY_FLAG);
                    printk("MT9P111_LITEON_INIT_FLAG = %d  Congratulations!It's running so fast! \n",MT9P111_LITEON_INIT_FLAG);
                    printk("MT9P111_LITEON_EXIT_STANDBY_FLAG = %d  Congratulations!It's running so fast! \n",MT9P111_LITEON_EXIT_STANDBY_FLAG);
                    mt9p111_liteon_exit_standby();
                    printk("mt9p111_liteon_sensor_setting---mt9p111_liteon_exit_standby\n");
                }
                printk("mt9p111_liteon_sensor_setting--setting preview---end\n");
            }
            else
            {
                mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x843C, 2);
            
                mt9p111_liteon_i2c_write_b_sensor(0x843C, 0x01,   1);
            
                mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x01,   1);
            
                mt9p111_liteon_i2c_write_b_sensor(0x0016, 0x0447, 2);

            
                msleep(100);

                for (time_out = 0; time_out < MT9P111_LITEON_STATUS_WAIT_TIMES_LONG; time_out++) //polling 0x8404 status until 0x00
                {
                    mt9p111_liteon_i2c_read(0x8404, &model_id); 
                    model_id = (model_id & 0xFF00 ) >> 8;    
                    CDBG(" %d, mt9p111_liteon reg=0x8404, value = 0x%x\n", time_out, model_id);
                    if (0 == model_id)
                        break;
                    msleep(10);
                }
                for (time_out = 0; time_out < MT9P111_LITEON_STATUS_WAIT_TIMES_MIDDLE; time_out++)//polling 0x8405 status until 0x03;
                {
                    mt9p111_liteon_i2c_read(0x8405, &model_id) ;
                    model_id = (model_id & 0xFF00 ) >> 8;                
                    CDBG(" %d  mt9p111_liteon reg=0x8405, value = 0x%x\n", time_out, model_id);
                    if (0x03 == model_id){
                        CDBG("succeed to entry preview mode now\n");
                        break;
                    }
                    msleep(20);
                }
                ...
                mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x8419, 2); // LOGICAL_ADDRESS_ACCESS [SEQ_STATE_CFG_1_AF]

                mt9p111_liteon_i2c_write_b_sensor(0x8419, 0x00,   1); // SEQ_STATE_CFG_1_AF

                mt9p111_liteon_i2c_write_b_sensor(0xC428, 0x82,   1); // AFM_DRIVER_CONTROL

                mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x05,   1); // SEQ_CMD      

                msleep(50);

            }
            msleep(20);
            CDBG("mt9p111_liteon_sensor_setting--setting preview---end\n");
            return rc;
        }
        else if(rt == RES_CAPTURE)
        {    
            CDBG("mt9p111_liteon_sensor_setting--setting Capture---begin\n");            

            mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x843C, 2);  
                
            mt9p111_liteon_i2c_write_b_sensor(0x843C, 0xFF,   1);    
                            
            mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x02,   1);    

            msleep(100);

            for (time_out = 0; time_out < MT9P111_LITEON_STATUS_WAIT_TIMES_LONG; time_out++)//polling 0x8404 status
            {
                mt9p111_liteon_i2c_read(0x8404, &model_id); 
                model_id = (model_id & 0xFF00 ) >> 8;    
            ...
            for (time_out = 0; time_out < MT9P111_LITEON_STATUS_WAIT_TIMES_SHORT; time_out++)//polling 0x8405 status till 0x07 for capture
            {
                mt9p111_liteon_i2c_read(0x8405, &model_id) ;
                model_id = (model_id & 0xFF00 ) >> 8;                
                CDBG(" %d  mt9p111_liteon reg=0x8405, value = 0x%x\n", time_out, model_id);
            ...
            if (0x07 != model_id){
                for (i=0; i<2;i++)
                {
                    CDBG("mt9p111_liteon_sensor_setting--setting Capture--time = %d\n", i+2);            
                    ...
                    //mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x8405, 2);  
                    for (time_out = 0; time_out < MT9P111_LITEON_STATUS_WAIT_TIMES_MIDDLE; time_out++)//polling 0x8404 status until 0x07;
                    {
                        mt9p111_liteon_i2c_read(0x8405, &model_id) ;
                        model_id = (model_id & 0xFF00 ) >> 8;                
                        CDBG(" %d,  mt9p111_liteon reg=0x8405, value = 0x%x\n", time_out, model_id);
...
static int32_t mt9p111_liteon_close_AF(void)
{
    int32_t rc = 0;
    uint16_t model_id = 0;
    int32_t timeout = 0;
    ...
    for (timeout = 0; timeout < 400; timeout+=10) //polling 0x8404 status until 0x00
    {
        mt9p111_liteon_i2c_read(0x8404, &model_id); 
        model_id = (model_id & 0xFF00 ) >> 8;	
        printk(" %d, mt9p111_liteon reg=0x8404, value = 0x%x\n", timeout, model_id);
        if (0 == model_id)
    	    break;
        msleep(10);
    }
    for (timeout = 0; timeout < 400; timeout+=10)//polling 0x8405 status until 0x03;
    {
        mt9p111_liteon_i2c_read(0x8405, &model_id) ;
        model_id = (model_id & 0xFF00 ) >> 8;				
        printk(" %d  mt9p111_liteon reg=0x8405, value = 0x%x\n", timeout, model_id);
        if (0x03 == model_id){
...
static int32_t mt9p111_liteon_video_config(int mode)
{
	int32_t rc = 0;
	int rt;
	/* change sensor resolution if needed */
	rt = RES_PREVIEW;
	if (mt9p111_liteon_sensor_setting(UPDATE_PERIODIC, rt) < 0)
		return rc;
	mt9p111_liteon_ctrl->curr_res = mt9p111_liteon_ctrl->prev_res;
	mt9p111_liteon_ctrl->sensormode = mode;
	return rc;
}

static int32_t mt9p111_liteon_snapshot_config(int mode)
{
	int32_t rc = 0;
	int rt;
	printk("mt9p111_liteon_snapshot_config-----begin\n");
	/* change sensor resolution if needed */
	rt = RES_CAPTURE;
	if (mt9p111_liteon_sensor_setting(UPDATE_PERIODIC, rt) < 0)
		return rc;
	mt9p111_liteon_ctrl->curr_res = mt9p111_liteon_ctrl->prev_res;
	mt9p111_liteon_ctrl->sensormode = mode;
	printk("mt9p111_liteon_snapshot_config-----end\n");
	return rc;
}

static int32_t mt9p111_liteon_set_sensor_mode(int mode,
	int res)
{
	int32_t rc = 0;
	switch (mode) {
	case SENSOR_PREVIEW_MODE:
		rc = mt9p111_liteon_video_config(mode);
		break;
	case SENSOR_SNAPSHOT_MODE:
		rc = mt9p111_liteon_snapshot_config(mode);
 ...
 static int mt9p111_liteon_set_effect(int mode,int8_t effect)
{
	int rc = 0;	
	printk("mt9p111_liteon_set_effect  effect=%d\n",effect);
	switch (effect) {
	case CAMERA_EFFECT_OFF: 
	      mt9p111_liteon_i2c_write_b_sensor(0x098E, 0xDC38, 2); 	// LOGICAL_ADDRESS_ACCESS [SYS_SELECT_FX]       
		mt9p111_liteon_i2c_write_b_sensor(0xDC38, 0x00,   1); 	// SYS_SELECT_FX                                  
		mt9p111_liteon_i2c_write_b_sensor(0xDC02, 0x307E, 2);  	// SYS_ALGO                                     
		//mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06,   1); 	// SEQ_CMD
	...
	case CAMERA_EFFECT_MONO: 
		...
		mt9p111_liteon_i2c_write_b_sensor(0x098E, 0xDC38, 2);  	// LOGICAL_ADDRESS_ACCESS [SYS_SELECT_FX] 
		mt9p111_liteon_i2c_write_b_sensor(0xDC38, 0x01,   1); 	// SYS_SELECT_FX                            
		mt9p111_liteon_i2c_write_b_sensor(0xDC02, 0x307E, 2);  	// SYS_ALGO                               
		//mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06,   1); 	// SEQ_CMD                                  
	...
	case CAMERA_EFFECT_NEGATIVE: 
		mt9p111_liteon_i2c_write_b_sensor(0x098E, 0xDC38, 2);  	// LOGICAL_ADDRESS_ACCESS [SYS_SELECT_FX]  
		mt9p111_liteon_i2c_write_b_sensor(0xDC38, 0x03,   1); 	// SYS_SELECT_FX                             
		mt9p111_liteon_i2c_write_b_sensor(0xDC02, 0x307E, 2);  	// SYS_ALGO                                
		//mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06,   1); 	// SEQ_CMD                                   
	...
	case CAMERA_EFFECT_SOLARIZE: 
		mt9p111_liteon_i2c_write_b_sensor(0x098E, 0xDC38, 2);  	// LOGICAL_ADDRESS_ACCESS [SYS_SELECT_FX] 
		mt9p111_liteon_i2c_write_b_sensor(0xDC38, 0x04,   1); 	// SYS_SELECT_FX                            
		mt9p111_liteon_i2c_write_b_sensor(0xDC02, 0x307E, 2);  	// SYS_ALGO                               
		mt9p111_liteon_i2c_write_b_sensor(0xDC39, 0x4E,   1);               // SYS_SOLARIZATION_TH
		//mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06,   1); 	// SEQ_CMD                                  
	...
	case CAMERA_EFFECT_SEPIA: 
	    mt9p111_liteon_i2c_write_b_sensor(0x098E, 0xDC38, 2);  	// LOGICAL_ADDRESS_ACCESS [SYS_SELECT_FX]     
	    mt9p111_liteon_i2c_write_b_sensor(0xDC38, 0x02,   1); 	// SYS_SELECT_FX                                
	    mt9p111_liteon_i2c_write_b_sensor(0xDC02, 0x307E, 2);  	// SYS_ALGO                                   
	    //mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06,   1); 	// SEQ_CMD                                      
...
static long mt9p111_liteon_set_whitebalance(int mode,int8_t wb)
{

	long rc = 0;
    int timeout =0;
    uint16_t value =0x00;
	printk("mt9p111_liteon_set_whitebalance  wb=%d\n",wb);

	switch (wb) {	
	case CAMERA_WB_AUTO: {
		mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x8410, 2); 	// LOGICAL_ADDRESS_ACCESS [SEQ_STATE_CFG_0_AWB]  
		mt9p111_liteon_i2c_write_b_sensor(0x8410, 0x02,   1); 	// SEQ_STATE_CFG_0_AWB                             
		mt9p111_liteon_i2c_write_b_sensor(0x8418, 0x02,   1);  	// SEQ_STATE_CFG_1_AWB                             
		mt9p111_liteon_i2c_write_b_sensor(0x8420, 0x02,   1);  	// SEQ_STATE_CFG_2_AWB                             
		mt9p111_liteon_i2c_write_b_sensor(0xAC44, 0x00,   1);  	// AWB_LEFT_CCM_POS_RANGE_LIMIT                    
		mt9p111_liteon_i2c_write_b_sensor(0xAC45, 0x7F,   1);  	// AWB_RIGHT_CCM_POS_RANGE_LIMIT                   
#if 1
		mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06,   1);  	// SEQ_CMD                                         
#endif
		mt9p111_liteon_i2c_write_b_sensor(0xAC04, 0x40,   1);  	// AWB_PRE_AWB_R2G_RATIO                           
		mt9p111_liteon_i2c_write_b_sensor(0xAC05, 0x4D,   1);  	// AWB_PRE_AWB_B2G_RATIO
		//msleep(50);
		for(timeout = 0;timeout < 600;timeout += 20)
        {
            mt9p111_liteon_i2c_read(0x8404, &value);
	...
	case CAMERA_WB_INCANDESCENT: {
		...
		mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x8410, 2); 	// LOGICAL_ADDRESS_ACCESS [SEQ_STATE_CFG_0_AWB]     
		mt9p111_liteon_i2c_write_b_sensor(0x8410, 0x01,   1); 	// SEQ_STATE_CFG_0_AWB                                
		mt9p111_liteon_i2c_write_b_sensor(0x8418, 0x01,   1); 	// SEQ_STATE_CFG_1_AWB                                
		mt9p111_liteon_i2c_write_b_sensor(0x8420, 0x01,   1); 	// SEQ_STATE_CFG_2_AWB                                
		mt9p111_liteon_i2c_write_b_sensor(0xAC44, 0x7F,   1); 	// AWB_LEFT_CCM_POS_RANGE_LIMIT                       
		mt9p111_liteon_i2c_write_b_sensor(0xAC45, 0x7F,   1); 	// AWB_RIGHT_CCM_POS_RANGE_LIMIT                      
		mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06,   1); 	// SEQ_CMD                                            
		msleep(50);
		mt9p111_liteon_i2c_write_b_sensor(0xAC04, 0x5B,   1); 	// AWB_PRE_AWB_R2G_RATIO                              
		mt9p111_liteon_i2c_write_b_sensor(0xAC05, 0x28,   1); 	// AWB_PRE_AWB_B2G_RATIO                              
 	...
 	case CAMERA_WB_DAYLIGHT: {
		...
		mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06,   1); 	// SEQ_CMD                                       
		msleep(50);
		mt9p111_liteon_i2c_write_b_sensor(0xAC04, 0x3C,   1); 	// AWB_PRE_AWB_R2G_RATIO                         
		mt9p111_liteon_i2c_write_b_sensor(0xAC05, 0x41,   1); 	// AWB_PRE_AWB_B2G_RATIO
	...
	case CAMERA_WB_CLOUDY_DAYLIGHT: {
		...
		mt9p111_liteon_i2c_write_b_sensor(0xAC45, 0x7F,   1); 	// AWB_RIGHT_CCM_POS_RANGE_LIMIT                 
		mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06,   1); 	// SEQ_CMD                                       
		mt9p111_liteon_i2c_write_b_sensor(0xAC04, 0x4B,   1); 	// AWB_PRE_AWB_R2G_RATIO                         
		mt9p111_liteon_i2c_write_b_sensor(0xAC05, 0x49,   1); 	// AWB_PRE_AWB_B2G_RATIO                         

		msleep(50);
		mt9p111_liteon_i2c_write_b_sensor(0xAC04, 0x3C,   1); 	// AWB_PRE_AWB_R2G_RATIO                         
		mt9p111_liteon_i2c_write_b_sensor(0xAC05, 0x55,   1); 	// AWB_PRE_AWB_B2G_RATIO                         
		...
		mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06,   1); 	// SEQ_CMD                                        
		msleep(50);
		mt9p111_liteon_i2c_write_b_sensor(0xAC04, 0x4A,   1); 	// AWB_PRE_AWB_R2G_RATIO                          
		mt9p111_liteon_i2c_write_b_sensor(0xAC05, 0x32,   1); 	// AWB_PRE_AWB_B2G_RATIO                          
...
static int mt9p111_liteon_set_antibanding(int mode,int8_t antibanding)
{
	int rc = 0;	
	...
	case CAMERA_ANTIBANDING_AUTO: 
		...
		mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x8417, 2); 
		mt9p111_liteon_i2c_write_b_sensor(0x8417, 0x02, 1); 
		mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06, 1); 
		break;
		
	case CAMERA_ANTIBANDING_60HZ: 
		//printk("%s  antibanding =CAMERA_ANTIBANDING_60HZ\n",__FUNCTION__);
		mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x8417, 2); 
		mt9p111_liteon_i2c_write_b_sensor(0x8417, 0x01, 1); 
		mt9p111_liteon_i2c_write_b_sensor(0xA004, 0x3C, 1); 
		mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06, 1);
		break;
	...
	case CAMERA_ANTIBANDING_50HZ: 
		...
		mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x8417, 2); 
		mt9p111_liteon_i2c_write_b_sensor(0x8417, 0x01, 1); 
		mt9p111_liteon_i2c_write_b_sensor(0xA004, 0x32, 1); 
		mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06, 1);
		break;
	...
	case CAMERA_ANTIBANDING_OFF: 
		...
		mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x8417, 2); 
		mt9p111_liteon_i2c_write_b_sensor(0x8417, 0x00, 1); 
		mt9p111_liteon_i2c_write_b_sensor(0x8404, 0x06, 1); 
		break;
...
static long mt9p111_liteon_set_default_focus(int mode,int32_t af_step)
{
	...
	int time_out = 0;
	CDBG("mt9p111_liteon_set_default_focus  begin \n");
	
	//[VCM_Enable  full scan1]

	mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x8419, 2); // LOGICAL_ADDRESS_ACCESS [SEQ_STATE_CFG_1_AF]
	
	mt9p111_liteon_i2c_write_b_sensor(0x8419, 0x04,   1); // SEQ_STATE_CFG_1_AF
	
	mt9p111_liteon_i2c_write_b_sensor(0xC428, 0x81,   1); // AFM_DRIVER_CONTROL
	...
	mt9p111_liteon_i2c_write_b_sensor(0x098E, 0xB006, 2);     // LOGICAL_ADDRESS_ACCESS [AF_PROGRESS]  
	                                         
	mt9p111_liteon_i2c_write_b_sensor(0xB006, 0x01,   1);       // AF_PROGRESS                        

	for (time_out = 0; time_out < MT9P111_LITEON_STATUS_WAIT_TIMES_LONG;  time_out++)
	{
		mt9p111_liteon_i2c_write_b_sensor(0x098E, 0xB007, 2);  
		mt9p111_liteon_i2c_read(0xB007, &model_id);
		model_id = (model_id & 0xFF00 ) >> 8;
		CDBG(" %d, lens pos = 0x%x\n", time_out, model_id);

		mt9p111_liteon_i2c_write_b_sensor(0x098E, 0x3000, 2); 	
		mt9p111_liteon_i2c_read(0xB000, &model_id);
    ...
    if (MT9P111_LITEON_STATUS_WAIT_TIMES_LONG == time_out){
		...
		rc = -EIO;
	 	...
	 	CDBG("mt9p111_liteon_set_default_focus  rc=%ld \n", rc);
		CDBG("mt9p111_liteon_set_default_focus  end \n");		
...
static int32_t mt9p111_liteon_power_down(void)
{
	printk("mt9p111_liteon_power_down\n");
	return 0;
}
static int mt9p111_liteon_probe_init_done(const struct msm_camera_sensor_info *data)
{
    int rc = 0;
...
#ifndef CONFIG_MT9P111_LITEON_OTP_LSC
static int mt9p111_liteon_probe_init_sensor(const struct msm_camera_sensor_info *data)
{
    uint16_t model_id = 0x0000;
    int32_t rc = 0;
    
    printk("mt9p111_liteon_probe_init_sensor-----------begin\n");
    
    printk("data->sensor_pwd = %d\n", data->sensor_pwd);
    printk("data->sensor_reset = %d\n", data->sensor_reset);

    rc = gpio_request(data->sensor_pwd, "mt9p111_liteon");
    if (!rc) {
        gpio_direction_output(data->sensor_pwd, 0);
        msleep(5);
    } else {
        printk("mt9p111_liteon gpio pwdn fail");
        goto init_probe_done;
    }
    ...
    printk("mt9p111_liteon model_id = 0x%x\n",
         model_id);
    /* 4. Compare sensor ID to MT9P111_LITEON ID: */
    if (model_id != MT9P111_LITEON_MODEL_ID) {
        rc = -ENODEV;
        goto init_probe_fail;
    }

    printk("mt9p111_liteon_probe_init_sensor-----------end\n");
    goto init_probe_done;
init_probe_fail:
    printk(KERN_INFO " mt9p111_liteon_probe_init_sensor fails_kalyani\n");
    gpio_free(data->sensor_reset);//release the GPIO for liteon sensor
    ...
    return rc;//if error,then return -1
init_probe_done:
    printk(KERN_INFO " mt9p111_liteon_probe_init_sensor finishes\n");
    return rc;
}
#endif
static int mt9p111_liteon_probe_open_sensor(void)
{
    uint16_t model_id;
    int32_t rc = 0;
    
    printk("mt9p111_liteon_probe_open_sensor-----------begin\n");
    
    rc = mt9p111_liteon_i2c_read(REG_MT9P111_LITEON_MODEL_ID, &model_id);
    if(rc<0)    
        goto init_probe_fail;

    printk("mt9p111_liteon_probe_open_sensor model_id = 0x%04x\n", model_id);
    ...
    printk("mt9p111_liteon_probe_open_sensor-----------end\n");
    goto init_probe_done;
    
init_probe_fail:
    printk(KERN_INFO "mt9p111_liteon_probe_open_sensor fails_kalyani\n");
    return rc;//if error,then return -1
init_probe_done:
    printk(KERN_INFO "mt9p111_liteon_probe_open_sensor finishes\n");
    return rc;
}
int mt9p111_liteon_sensor_open_init(const struct msm_camera_sensor_info *data)
{
	int32_t rc = 0;

	printk("%s: %d\n", __func__, __LINE__);
	printk("Calling mt9p111_liteon_sensor_open_init\n");
	mt9p111_liteon_ctrl = kzalloc(sizeof(struct mt9p111_liteon_ctrl_t), GFP_KERNEL);
	if (!mt9p111_liteon_ctrl) {
		CDBG("mt9p111_liteon_init failed!\n");
		rc = -ENOMEM;
		goto init_done;
	}
	mt9p111_liteon_ctrl->fps_divider = 1 * 0x00000400;
	mt9p111_liteon_ctrl->pict_fps_divider = 1 * 0x00000400;
	mt9p111_liteon_ctrl->fps = 30 * Q8;
	mt9p111_liteon_ctrl->set_test = TEST_OFF;
	mt9p111_liteon_ctrl->prev_res = QTR_SIZE;
	mt9p111_liteon_ctrl->pict_res = FULL_SIZE;
	mt9p111_liteon_ctrl->curr_res = INVALID_SIZE;

	if (data)
		mt9p111_liteon_ctrl->sensordata = data;

	/* enable mclk first */

	msm_camio_clk_rate_set(24000000);
	msleep(20);
    rc = mt9p111_liteon_probe_open_sensor();
    //rc = mt9p111_liteon_probe_init_sensor(data);
    if (rc < 0) {
        printk("Calling mt9p111_liteon_probe_open_sensor fail\n");
        goto init_fail;
    }
	rc = mt9p111_liteon_sensor_setting(REG_INIT, RES_PREVIEW);
...
init_fail:
	printk(" mt9p111_liteon_sensor_open_init fail\n");
	mt9p111_liteon_probe_init_done(data);
	kfree(mt9p111_liteon_ctrl);
init_done:
	printk("mt9p111_liteon_sensor_open_init done\n");
	return rc;
}

static int mt9p111_liteon_init_client(struct i2c_client *client)
{
	/* Initialize the MSM_CAMI2C Chip */
	init_waitqueue_head(&mt9p111_liteon_wait_queue);
	return 0;
}

static const struct i2c_device_id mt9p111_liteon_i2c_id[] = {
	{"mt9p111_liteon", 0},
	{ }
};

static int mt9p111_liteon_i2c_probe(struct i2c_client *client,
	const struct i2c_device_id *id)
{
	int rc = 0;
	printk("mt9p111_liteon_i2c_probe called!\n");
	...
	mt9p111_liteon_sensorw = kzalloc(sizeof(struct mt9p111_liteon_work_t), GFP_KERNEL);
	if (!mt9p111_liteon_sensorw) {
		CDBG("kzalloc failed.\n");
		rc = -ENOMEM;
		goto probe_failure;
	}

	i2c_set_clientdata(client, mt9p111_liteon_sensorw);
	mt9p111_liteon_init_client(client);
	mt9p111_liteon_client = client;

	msleep(50);

	printk("mt9p111_liteon_probe successed! rc = %d\n", rc);
	return 0;

probe_failure:
	printk("mt9p111_liteon_i2c_probe failed! rc = %d\n", rc);
	return rc;
}

static int __exit mt9p111_liteon_remove(struct i2c_client *client)
{
	struct mt9p111_liteon_work_t_t *sensorw = i2c_get_clientdata(client);
	free_irq(client->irq, sensorw);
	mt9p111_liteon_client = NULL;
	kfree(sensorw);
	return 0;
}

static struct i2c_driver mt9p111_liteon_i2c_driver = {
	.id_table = mt9p111_liteon_i2c_id,
	.probe  = mt9p111_liteon_i2c_probe,
	.remove = __exit_p(mt9p111_liteon_remove),
	.driver = {
		.name = "mt9p111_liteon",
	},
};

int mt9p111_liteon_sensor_config(void __user *argp)
{
	...
	if (copy_from_user(&cdata,
		...
		return -EFAULT;
	mutex_lock(&mt9p111_liteon_mut);
	CDBG("mt9p111_liteon_sensor_config: cfgtype = %d\n",
	cdata.cfgtype);
	switch (cdata.cfgtype) {
	case CFG_SET_MODE:
		rc = mt9p111_liteon_set_sensor_mode(cdata.mode,
			cdata.rs);
		break;
	case CFG_SET_DEFAULT_FOCUS:
		rc=mt9p111_liteon_set_default_focus(
					cdata.mode,
					cdata.cfg.focus.steps);
		break;
	case CFG_SET_EFFECT:
		rc = mt9p111_liteon_set_effect(
					cdata.mode,
					cdata.cfg.effect);
		break;	
	case CFG_SET_WB:
		rc=mt9p111_liteon_set_whitebalance(
					cdata.mode,
					cdata.cfg.whitebalance);
		break;

	case CFG_PWR_DOWN:
		rc = mt9p111_liteon_power_down();
		break;
		
      case CFG_SET_ANTIBANDING:
		rc = mt9p111_liteon_set_antibanding(
						cdata.mode,
	...
	mutex_unlock(&mt9p111_liteon_mut);

	return rc;
}
static int mt9p111_liteon_sensor_release(void)
{
	int rc = -EBADF;
	printk("mt9p111_liteon_release begin\n");
	mutex_lock(&mt9p111_liteon_mut);
#if 0
	mt9p111_liteon_power_down();
	gpio_set_value_cansleep(mt9p111_liteon_ctrl->sensordata->sensor_reset, 0);
	gpio_free(mt9p111_liteon_ctrl->sensordata->sensor_reset);

	msleep(5);
	gpio_direction_output(mt9p111_liteon_ctrl->sensordata->sensor_pwd, 1);
	gpio_free(mt9p111_liteon_ctrl->sensordata->sensor_pwd);
	msleep(10);
#else
    mt9p111_liteon_enter_standby();
#endif   
	kfree(mt9p111_liteon_ctrl);
	mt9p111_liteon_ctrl = NULL;
	printk("mt9p111_liteon_release completed\n");
	mutex_unlock(&mt9p111_liteon_mut);

	return rc;
}

static int mt9p111_liteon_sensor_probe(const struct msm_camera_sensor_info *info,
		struct msm_sensor_ctrl *s)
{
    ...
    {
        printk("mt9p111_liteon_sensor_probe-----------begin\n");
        rc = i2c_add_driver(&mt9p111_liteon_i2c_driver);
        if (rc < 0 || mt9p111_liteon_client == NULL)
        {
            rc = -ENOTSUPP;
            goto probe_fail;
        }
#ifdef CONFIG_MT9P111_LITEON_OTP_LSC
        //mt9p111_liteon_probe_init_sensor_otp(info);
        rc = mt9p111_liteon_probe_init_sensor_otp(info);
        if (rc < 0)
            goto probe_fail;
#else
        msm_camio_clk_rate_set(24000000);
        ...
        rc = mt9p111_liteon_probe_init_sensor(info);
        if (rc < 0)
            goto probe_fail;
#endif

        //if in mt9p111_liteon_probe_init_sensor(info) the system find a sensor,the system will run the follow program.
        ...
        s->s_init = mt9p111_liteon_sensor_open_init;
        s->s_release = mt9p111_liteon_sensor_release;
        s->s_config  = mt9p111_liteon_sensor_config;
        ...
        mt9p111_liteon_close_AF();
        //mt9p111_liteon_probe_init_done(info);
        //Enter the software standby mode.
        rc = mt9p111_liteon_enter_standby();
        if(rc < 0)
        {
        ...
        {
            printk("The system will use the sensor of  MT9P111_liteon\n");
            printk("mt9p111_liteon_sensor_probe-----------end\n");
            return rc;
        }
    }
    else
...
probe_fail://if running here,you must restart you machine.
    printk("mt9p111_liteon_sensor_probe: sensor probe failed.!\n");
    //if enter_standby failed,reset the sensor,or the sensor is running at all times
    mt9p111_liteon_probe_init_done(info);
    i2c_del_driver(&mt9p111_liteon_i2c_driver);
    return rc;
}
static int __mt9p111_liteon_probe(struct platform_device *pdev)
{

	return msm_camera_drv_start(pdev, mt9p111_liteon_sensor_probe);
}

static struct platform_driver msm_camera_driver = {
	.probe = __mt9p111_liteon_probe,
	.driver = {
...
static int __init mt9p111_liteon_init(void)
{
	return platform_driver_register(&msm_camera_driver);
}

module_init(mt9p111_liteon_init);
