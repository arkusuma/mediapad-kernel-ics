...
#include <linux/input/gs_st.h>
#include "linux/hardware_self_adapt.h"
#include <linux/slab.h>
#include <mach/board.h>

#define GS_SENSOR_HW_T3  0
#define GS_POLLING   1
...
static void gs_work_func(struct work_struct *work)
{
	...
	if (status & (1<<3)) {
...
#if defined(GS_SENSOR_HW_T3) || S7_HWID_L3H(S7, S7301, T0)
		...
		#endif
		/*Modified by yixnuehui 00141414, 2009-12-28 end */
	/* debug message. suchangyu. 20100414. begin */
#if 0
	printk(KERN_ALERT "[gs_work_func] report ABS_X:%d, ABS_Y:%d, ABS_Z:%d\n", x, y, z);
#endif
	/* debug message. suchangyu. 20100414. end */
