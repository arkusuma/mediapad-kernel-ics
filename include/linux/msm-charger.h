...
#ifndef CONFIG_BATTERY_MSM8X60_S7PRO
...
struct msm_hardware_charger {
	...
	int rating;
	unsigned gpio_num;
	int (*chg_detection_config) (int flag, unsigned gpio_num);
	int (*get_charger_status)(unsigned gpio_num);	
...
|| defined(CONFIG_BATTERY_MSM8X60_S7PRO) || defined(CONFIG_BATTERY_MSM8X60_S7PRO_MODULE)
