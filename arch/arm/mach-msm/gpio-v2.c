...
/*===========================================================================
  Function:       msm_gpios_enable
  Description:    To enable GPIOs in the given table
  Calls:          
  Called By:      bluetooth_power
  Input:          pointer to a table contains GPIOs to be enabled
                  size: size of the table
  Output:         none
  Return:         0: success
                  others: GPIO index of enable failed in table
  Others:         none
===========================================================================*/
...
/*===========================================================================
  Function:       msm_gpios_disable
  Description:    To disable GPIOs in the given table
  Calls:          
  Called By:      msm_gpios_enable
  Input:          pointer to a table contains GPIOs to be disabled
                  size: size of the table
  Output:         none
  Return:         0: success
                  others: GPIO index of enable failed in table
